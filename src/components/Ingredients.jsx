...
import vegetables from '../images/veges.jpg'
import sauce from '../images/pizza-sauce.jpg'

export const Ingredients = () => {
  return (
    
        <div className='container mx-36 px-6  flex justify-center items-center'>
            <div className='grid cols-1 md:grid-cols-3 gap-20 mt-20 mb-20'>
                <div>
                 ...
                 <p className=''>We use the freshest vegetables for our toppings to give you the most flavourful and healthy options.</p>
                </div>
                <div>
                 <img src={pizza} className='rounded-full size-56' ></img>
                 <h3 className='text-2xl text-blue-700 font-bold ml-20 mt-5 mb-5'>Pizza</h3>
                 <p>Our pizzas are made from only the finest ingredients, including homemade dough and sauce, to give you an authentic pizza experience.</p>
                </div>
                <div>
                 ...
                 <p>Our homemade pizza sauce is made with the freshest tomatoes, herbs, and spices for a taste you won't find anywhere else.</p>
                </div>
